    ...
    <div class="space-y-8">
        ...
        <header class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
                ...
                <p class="mt-1 text-sm text-gray-400">A list of all users in your system including their name, email, and phone.</p>
            </div>
                        ...
                        <tr class="group hover:bg-white/4 transition-all duration-200">
                            <td class="px-6 py-4">
                                <div class="flex items-center gap-3">
                                    ...
                                    <span class="font-semibold text-gray-100 group-hover:text-cyan-400">{{ $user->name }}</span>
                                </div>
                            </td>
